...
class chat_GUI:
    ...
    def Setup(self):
        ...
        self.Window.title("LiBot v1.0 - University of Lincoln Library Chatbot")
    ...
    #Function to insert a blank line after message. Prevents oversized message boxes.
...
chat_file_path = 'chatlog'
if os.path.exists(chat_file_path) == False:
    os.mkdir(chat_file_path)
savefile = open(chat_file_path + '\\' + str(timestamp) + ".txt", "a")
...
kb_file_path = "\\resources\\Knowledge_Base.xlsx"

#Create a dataframe/knowledge base
df = pd.read_excel(application_path + kb_file_path, usecols = ['Context', 'Response']) # reads excel file
